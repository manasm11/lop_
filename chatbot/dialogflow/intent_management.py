...
"""
'''My examples:
    python intent_management.py --project-id 'bot-test-303915' create 'who are you?' --training-phrases-parts "tell me about yourself" "who are you" "what are you" "what do you do?" --message-texts "I am a chatbot" "I am a chetbot designed to help you"
'''
